  ...
  useEffect(() => {
    const loadOpportunities = async () => {
      ...
      try {
        ...
        const response = await fetch(`${API_URL}/opportunities?${query}`, {
    ...
    <div className="opportunity-page-volunteer">
      ...
      <div className="filter-container-volunteer">
        ...
        <div className="suggestion-tags-volunteer">
          <span className="suggestion-tag-volunteer">web development</span>
          <span className="suggestion-tag-volunteer">Translation</span>
          <span className="suggestion-tag-volunteer">Marketing</span>
          <span className="suggestion-tag-volunteer">New York</span>
          <span className="suggestion-tag-volunteer">Remote</span>
          <span className="suggestion-tag-volunteer">Chicago</span>
        </div>
      </div>
